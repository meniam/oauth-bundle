...
use Meniam\OauthBundle\Oauth\Exception\HttpTransportException;
use Meniam\OauthBundle\Oauth\RequestDataStorageInterface;
use Meniam\OauthBundle\Oauth\ResourceOwnerInterface;
use Meniam\OauthBundle\Oauth\Response\PathUserResponse;
use Meniam\OauthBundle\Oauth\Response\UserResponseInterface;
...
abstract class AbstractResourceOwner implements ResourceOwnerInterface
{
    ...
    {
        throw new AuthenticationException("OAuth error: Method unsupported. Token: {$token}");
    }
